...
(function (global) {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    $ajaxUtils.sendGetRequest(
      allCategoriesUrl,
      buildAndShowHomeHTML, // Replaced with the function reference as required.
      true
  ...
  function buildAndShowHomeHTML(categories) {
    ...
    $ajaxUtils.sendGetRequest(
      homeHtmlUrl,
      function (homeHtml) {
        // STEP 2: Call chooseRandomCategory with 'categories' parameter
      ...
      false
    ); // False because we're getting plain HTML, not JSON
  }
